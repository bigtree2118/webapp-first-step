...
//    jQuery.fn.__unbind__ = jQuery.fn.unbind;
    ...
    jQuery.fn.hotunbind = function (type, combi, fn){
        ...
        if (combi && typeof combi === 'string'){
            ...
            for (var x=0; x<hkTypes.length; x++){
            	fn = hotkeys.triggersMap[selectorId][hkTypes[x]][combi];
    ...
    jQuery.fn.hotbind = function(type, data, fn){
        ...
        if (jQuery.isFunction(data) || !handle){
            ...
            if (pass2jq){
                result = this.bind(pass2jq, data, fn);
            }            
            //alert((typeof data === "string")+"___"+data+"___type:"+type+"___fn:"+fn);
            ...
            if(data.combi){
                for (var x=0; x < handle.length; x++){
                    ...
                    //result = this.bind(handle.join(' '), data, fn);
                    result = this.bind(handle.join(' '), data, hotkeys.handler)
                }
            }
            return result;
        }
