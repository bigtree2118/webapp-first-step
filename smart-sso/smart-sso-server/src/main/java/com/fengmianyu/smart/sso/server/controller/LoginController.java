...
import com.fengmianyu.smart.sso.server.common.Config;
import com.fengmianyu.smart.sso.server.common.KeyGenerator;
import com.fengmianyu.smart.sso.server.common.LoginUser;
import com.fengmianyu.smart.sso.server.common.Loginable;
...
import com.fengmianyu.smart.sso.server.util.ApplicationUtils;
...
public class LoginController {
	...
	public String login(
		...
		if (!result.isSuccess()) {
			request.setAttribute(Loginable.VALIDATE_MESSAGE_NAME, result.getMsg());
			request.setAttribute("backUrl", backUrl);
			request.setAttribute("appCode", appCode);
			return Loginable.LOGIN_PATH;
		}
