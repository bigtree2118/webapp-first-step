package com.fengmianyu.smart.util;
...
public class DateUtils {
	...
	public static Integer timeToInt(String time){
		if(time!=null && time!=""){
			...
			Integer second =Integer.valueOf(arr[2]);
	 ...
	 * @return
	 */
	public static String formatDate(Integer second,String format){
		String dateStr="";
		if(second!=null){
		SimpleDateFormat sdf = new SimpleDateFormat(format);
		 	dateStr = sdf.format(new Date(second*1000L)) ;
		}
		return dateStr;
	}
}
